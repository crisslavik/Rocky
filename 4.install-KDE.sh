...
sudo dnf install sddm vscode dolphin slack plasma-systemmonitor gwenview kcalc krdc kde-gtk-config konsole firefox ark krfb sddm-breeze google-chrome -y
